...
<br>
<p><h3 style="color:#4682B4">Хотим уведомить Вас, что через <span class="colortext_2">$DAYS_ALERT</span> дней заканчивается срок действия подписки на услуги технической поддержки по следующим продуктам:</h3></p> 
...
<p><h4 style="color:#4682B4">Дата и время окончания действия учетной записи "$Alert_login" на портале НЕОСФЕРА: <span class="colortext_2">$Alert_Date_Time_Expiration</span></h4></p>
